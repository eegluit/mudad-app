...
class ColorResource {
  ...
  static const Color textColor_8 = Color(0xff797979);
  ...
  static const Color lightGreenColor = Color(0xffAAD977);
  static const Color lightBrownColor = Color(0xffD0B081);
  static const Color lightPinkColor = Color(0xffF5878A);
