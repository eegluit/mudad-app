              ...
              return Column(
                children: [
                  Visibility(
                      ...
                      child: CommonButton(text:controller.currentStep.value == 1? "Get Started": controller.currentStep.value == 2 ? "Continue" : controller.currentStep.value == 3 ? controller.selectSelfie.value.path !=""? "Next":"Start" : controller.isVerified.value ?"Next":"Try Again", loading: false, onPressed: controller.currentStep.value == 1? controller.onVerifyIdentity:controller.currentStep.value == 2?controller.onSelectId:controller.currentStep.value == 3?controller.onTakeSelfie:controller.onVerificationComplete , color: ColorResource.mainColor)),
                  Visibility(
          ...
          return Column(
            children: [
             ...
             Container(
               ...
               child: controller.selectSelfie.value.path == ""? ClipRRect(
                   borderRadius:  BorderRadius.all(Radius.elliptical(170,220)),
                   child: cachedNetworkImage(ImageResource.instance.defaultUser)):ClipRRect(
