                          ...
                          return Column(
                            ...
                            children: [
                              ...
                              CommonTextField(
                                ...
                                validator: (value) {
                                  if (value!.isEmpty) {
                                    controller.fNameError.value = "Please enter your first name.".tr;
                                    return "";
                                  } else if (value.removeAllWhitespace == "") {
                                    controller.fNameError.value = "Please enter valid name.".tr;
                                    return null;
                                  } else {
                              ...
                              CommonTextField(
                                ...
                                validator: (value) {
                                  if (value!.isEmpty) {
                                    controller.lNameError.value = "Please enter your last name.".tr;
                                    return "";
                                  } else if (value.removeAllWhitespace == "") {
                                    controller.lNameError.value = "Please enter valid name.".tr;
                                    return null;
                                  } else {
                              ...
                              CommonTextField(
                                ...
                                validator: (value) {
                                  if (value!.isEmpty) {
                                    controller.profError.value = "Please enter your profession.".tr;
                                    return "";
                                  } else if (value.removeAllWhitespace == "") {
                                    controller.profError.value = "Please enter valid profession.".tr;
                                    return null;
                                  } else {
                              ...
                              CommonTextField(
                                ...
                                validator: (value) {
                                  if (value!.isEmpty) {
                                    controller.empNameError.value = "Please enter your employer name.".tr;
                                    return "";
                                  } else if (value.removeAllWhitespace == "") {
                                    controller.empNameError.value = "Please enter valid name.".tr;
                                    return null;
                                  } else {
                              ...
                              CommonTextField(
                                ...
                                validator: (value) {
                                  if (value!.isEmpty) {
                                    controller.empAddError.value = "Please enter your employer address.".tr;
                                    return "";
                                  } else if (value.removeAllWhitespace == "") {
                                    controller.empAddError.value = "Please enter valid address.".tr;
                                    return null;
                                  } else {
                              ...
                              CommonTextField(
                                ...
                                validator: (value) {
                                  if (value!.isEmpty) {
                                    controller.incomeError.value = "Please enter your monthly income.".tr;
                                    return "";
                                  } else if (value.removeAllWhitespace == "") {
                                    controller.incomeError.value = "Please enter valid income.".tr;
                                    return null;
                                  } else {
                                  ...
                                  onPressed: () {
                                    if (controller.formKey.currentState?.validate()??false) {
                                      ...
                                      controller.creditService
                                        ...
                                        controller.empolyerController.value.text,
                                        ...
                                        if (response.code != null) {
                                          ...
                                          controller.professionController.value.clear();
                                          controller.empolyerController.value.clear();
